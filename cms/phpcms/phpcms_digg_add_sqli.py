    ...
    def run(self):
        ...
        try:
            ...
            if r"81dc9bdb52d04dc20036dbd8313ed055" in req.text:
                cprint("[+]存在PHPCMS digg_add.php SQL注入漏洞...(高危)\t\tpayload: "+vulnurl, "red")
                postdata = {self.url:"存在PHPCMS digg_add.php SQL注入漏洞...(高危)\t\tpayload: "+vulnurl}
                requests.post('http://localhost:8848/cms', json=postdata)
            else:
                cprint("[-]不存在phpcms_digg_add_sqli漏洞", "white", "on_grey")
